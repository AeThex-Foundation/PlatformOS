...
const docNavigation: DocNavItem[] = [
  {
    ...
    description: "Foundation Learning Hub",
  },
  {
    title: "Getting Started",
    path: "/docs/getting-started",
    icon: <Zap className="h-5 w-5" />,
    description: "Enrollment & learning paths",
  },
  {
    title: "FAQs & Support",
    path: "/docs/platform",
  ...
  },
  {
    ...
    icon: <BookOpen className="h-5 w-5" />,
    description: "What you'll learn in each track",
  },
  {
    title: "Ethos Audio",
    path: "/docs/curriculum/ethos",
    icon: <BookMarked className="h-5 w-5" />,
    description: "Music production curriculum",
  },
  {
