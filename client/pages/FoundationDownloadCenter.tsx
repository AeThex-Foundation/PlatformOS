...
const categoryColors: Record<string, string> = {
  ...
  "web-dev": "from-gold-500 to-cyan-500",
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-900/20 to-slate-950 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            ...
            <Card className="bg-slate-800/50 border-slate-700 text-center">
              <CardContent className="pt-6">
                <div className="text-3xl font-bold text-gold-400">82+</div>
          ...
          {/* Info */}
          <div className="mt-12 p-6 bg-aethex-900/20 border border-aethex-700/50 rounded-lg">
