        ...
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border-b border-green-400/20 py-4 relative z-20">
          <div className="container mx-auto max-w-6xl px-4">
            <div className="flex items-center gap-3 text-sm">
              <Badge className="bg-green-500/20 text-green-300 border-green-400/40 text-xs">Foundation Program Staff</Badge>
              <p className="text-green-100/70">
                Educational program instructors and coordinators - Nonprofit workforce development team
              </p>
            </div>
          </div>
        </div>
